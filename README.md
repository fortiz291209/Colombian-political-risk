...
├── cpp/
│   ├── include/
│   │   ├── backtester.hpp      # C++ high-performance backtesting engine
│   │   └── timeseries.hpp      # C++ rolling statistics, event study, risk metrics
│   └── src/
│       └── pybindings.cpp      # CPython/NumPy bindings for Python integration
├── CMakeLists.txt
├── requirements.txt
└── README.md
```
